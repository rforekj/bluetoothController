...
//        imageView.setBackgroundColor(getResources().getColor(R.color.colorOff));
        ...
        buttonToggle1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String cmdText = null;
                String btnState = buttonToggle1.getText().toString().toLowerCase();
                if(btnState.contains("turn on")) {
                    buttonToggle1.setText("LED 1: Turn Off");
                    cmdText = "1on";
                } else {
                    buttonToggle1.setText("LED 1: Turn On");
                    cmdText = "1off";
                }
        ...
        buttonToggle2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String cmdText = null;
                String btnState = buttonToggle2.getText().toString().toLowerCase();
                if(btnState.contains("turn on")) {
                    buttonToggle2.setText("LED 2: Turn Off");
                    cmdText = "2on";
                } else {
                    buttonToggle2.setText("LED 2: Turn On");
                    cmdText = "2off";
                }
                connectedThread.write(cmdText);
            }
        ...
        buttonToggle3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String cmdText = null;
                String btnState = buttonToggle3.getText().toString().toLowerCase();
                if(btnState.contains("turn on")) {
                    buttonToggle3.setText("LED 3: Turn Off");
                    cmdText = "3on";
                } else {
                    buttonToggle3.setText("LED 3: Turn On");
                    cmdText = "3off";
                }
                connectedThread.write(cmdText);
            }
